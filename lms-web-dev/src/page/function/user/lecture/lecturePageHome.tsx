...
import { LeftSquareOutlined, RightSquareOutlined, UserOutlined, SnippetsOutlined, SettingOutlined, ContainerOutlined, EditOutlined, ProfileOutlined, LogoutOutlined } from '@ant-design/icons';
import 'tailwindcss';
                ...
                >
                    ...
                    <div style={{ padding: '16px', borderTop: '1px solid #f0f0f0' }}>
                        ...
                        >
                            ...
                            {!collapsed && <span style={{ marginLeft: 8, fontWeight: 'bold' }}>{user.name.split(' ').pop()}</span>}
                        </Button>

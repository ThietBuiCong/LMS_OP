...
import StudentHomePage from '././student/coursePageHome';
...
function UserHomePage() {
    ...
    const isStudent = user.role_id === 3 || user.role_id === "3";
    ...
    const menuItems = [
        ...
        // Sử dụng spread kết hợp điều kiện để thêm hoặc không thêm phần tử vào mảng
        ...(!isStudent ? [{ 
            key: '2', 
        ...
        <div> {/* Đảm bảo bao ngoài là flex */}
            ...
            <Layout>
                ...
                >
                    ...
                    <Menu style={{ marginTop: "20px", border: "none" }} items={[
                ...
                <Content>
                    {selectedKey === "1" && (
                        user.role_id === "3" || user.role_id === 3 ? <StudentHomePage /> : <CourseManagement />
                    )}
                    {selectedKey === "2" && !isStudent &&<CourseEdit />}
                    {selectedKey === "3" && "Chức năng đang phát triển"}
                </Content>
            </Layout>
        </div>
    );
